...
df_rename.rename(
    columns={"housing_median_age": "juss1", "households": "juss2"}, inplace=True
)
df_rename.columns
...
df.columns
group_dict = {"ocean_proximity": "prox", "longitude": "tude", "latitude": "tude"}
...
df_with_agg = pd.merge(df, df_group3, on="ocean_proximity", how="left")
df_with_agg[["ocean_proximity", "housing_median_age", "mean_housing_median_age"]]
...
df.pivot_table(index=["ocean_proximity"], columns="housing_median_age", aggfunc="mean")
...
df_typechange["lat_as_float64"] = df_typechange["lat_as_string"].astype("float64")
